<template>
  ...
  >
    ...
    ><MoreFilled
        @mousedown="_"
        style="width: 1.2em; height: 1.2em;margin: 5px;"></MoreFilled></div>
...
export default class Path extends Vue {
  ...
  openmenu(e:MouseEvent){
    ...
    const c= RightMenuFuncTs.RightMenuContent.create()
    ...
    console.log("open path menu")
    AppFuncTs.get_ctx().uiman_rightmenu.open_any_click(e,c)
