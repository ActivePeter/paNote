...
export default {
  ...
  computed: {
    ...
    anki_connected(){
      return AppFuncTs.appctx.anki_connected
    }
  },
  data() {
    return {
  ...
  methods: {
    ...
    add_card_set() {
      this.review_part_man.add_cardset(this.input_card_set_name)
    ...
    final_add_new_card(front, back) {
      this.review_part_man.add_or_edit_card_curset(this,front,back)
